...
- **[Developer Overview & Contributing](.././overview/):** Setup instructions, coding standards, and PR workflows.
- **[Extending Protostar](.././extending-protostar/):** Build new tooling or preset modules to accompany your tests.
- **[The Orchestrator](../../mechanics/orchestrator/):** Understand the engine bulkhead and execution lifecycle under test.
