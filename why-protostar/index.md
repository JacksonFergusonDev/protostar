...
Full IDE Autocomplete & Schema Validation
...
*(For a deeper visual breakdown of this two-phase execution, see [Design Principles](.././design-principles/)).*
...
| **IDE Validation**      | Jinja syntax breaks in-repo linters          | JSON Schema autocompletion & validation                       |
...
- **[Getting Started](.././getting-started/):** Install Protostar and scaffold your first project in seconds.
- **[Environment Initialization](.././usage/init/):** Learn how to run Protostar interactively via the TUI wizard or headlessly via CLI flags.
- **[Templates & Portable Configs](.././usage/templates/):** Explore declarative TOML blueprints, remote templates, and dynamic variable interpolation.
- **[The Orchestrator](.././mechanics/orchestrator/):** Understand the two-phase execution engine that guarantees atomicity and safe configuration merges.
