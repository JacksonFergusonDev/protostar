...
# --- File Appends ---
# Lines appended to existing files, creating them if necessary.

[appends]
"pyproject.toml" = ["# Custom comment appended to bottom of pyproject.toml"]
```

Exporting the JSON Schema (`protostar export-schema`)
...
Templates registered in your global `config.toml` aliases bypass this prompt. For a complete breakdown of how the runtime evaluates trust boundaries, see the [Remote Trust Model](../templates/#security-model-the-remote-trust-dialog).
...
- **[Templates & Portable Configs](.././templates/):** Learn about CLI options, URL translation, and template consumption.
- **[Global Configuration](.././configuration/):** Register your custom templates under `[templates]` in your `config.toml`.
- **[Extending Protostar](../../developer/extending-protostar/):** Implement custom Python bootstrap modules if your project requires engine-level integrations.
