...
- **[Error Handling Architecture](../../mechanics/error_handling/):** Deep dive into the domain exception hierarchy, POSIX exit codes, and subprocess telemetry.
- **[Environment Initialization](.././init/):** Review collision handling, AST injection, and `--force-merge` behavior.
- **[Global Configuration](.././configuration/):** Learn how to view, modify, or reset your global settings with `protostar config --reset`.
