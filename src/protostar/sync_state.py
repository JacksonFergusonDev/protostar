...
SCHEMA_VERSION = 1
STATE_HEADER = (
    "# Generated by Protostar. Records the project changes Protostar last accepted.\n"
    "# Commit this file with pyproject.toml; status, diff, and sync require it.\n"
    "# Keep it while using Protostar. If lost, restore it from version control.\n"
    "# You can delete it when you no longer use Protostar for this project.\n\n"
)
